...
function qrValue(unit: ConsumableUnit): string {
  return window.location.origin + '/consumable-library?scan=' + encodeURIComponent(unit.unit_code);
}
